...
creates a file called: package.json, inside your project folder.
That file is the identity card + control center of your Node/JS/TS project.
...
const task2: {id: number; title: string}  = {
  id: 2,
